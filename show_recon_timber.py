...
test_dset = timber_axis_loader.timberDataset( root='./dataset/timber_axis/test')
...
for i, data in enumerate(test_dataloader, 0):
    ...
    real_center.resize_(target.size()).copy_(target)
...
#    if a!=b:
        print('第%i个补充结果：不保存，errG=%f'%(i, errG))
        ...
        print('第%i个补充结果：保存，errG=%f'%(i, errG))
